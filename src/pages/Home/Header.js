...
const Header = () => {
  ...
  return (
    <div className='flex justify-between items-start'>
      <div className='flex'>
        <h2 className='font-semibold mr-8 mt-2'>Çalışan Listesi</h2>
          ...
          {({ values, errors, touched }) => (
            <Form>
              <div className='relative'>
                <Field type='text' name='searchValue' placeholder='Çalışan ara' className='w-72 outline-1 outline-blue-600 border border-gray-300 rounded-md py-2 px-2' />
                <button type='submit'>
      ...
      <button className='inline-block bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all px-4 py-1 mt-2'>Yeni Ekle</button>
    </div>
  )
}
